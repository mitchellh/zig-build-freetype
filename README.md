# Freetype built with Zig

This project builds [Freetype](https://github.com/freetype/freetype)
...
.{
    ...
    .dependencies = .{
        .freetype = .{
            .url = "https://github.com/mitchellh/zig-build-freetype/archive/<git-ref-here>.tar.gz",
